	...
	<div class="my-20 w-3/4 lg:w-1/2 mx-auto rounded-xl bg-base-200">
		<div v-if="$device.isMobile" class="p-4">
			...
			<div>
				...
				<div class="flex justify-evenly"><button class="btn btn-primary scale-75" @click="analyzing = true">Analyze</button></div>
			</div>
		</div>
		<div v-else class="w-3/4 mx-auto p-4">
			...
			<div class="flex w-full justify-between">
				...
				<button class="btn btn-primary" @click="()=>{analyzing = true;await analyze()}">Analyze</button>
			</div>
		</div>
