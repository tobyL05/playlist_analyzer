...
<template>
	<div class="my-20 w-3/4 lg:w-1/2 mx-auto rounded-xl bg-base-200">
		<div v-if="$device.isMobile" class="p-4">
			...
			<div>
				...
				<div class="flex justify-evenly">
					<button class="btn btn-primary scale-75" @click="() => {
							analyzing = true;
							analyze();
						}
						">
		...
		<div class="p-8 mx-auto flex w-inherit justify-evenly space-x-5 text-ellipsis">
			<AcousticnessBar class="w-1/6 mx-auto"/>
			<DanceabilityBar class="w-1/6 mx-auto"/>
			<EnergyBar class="w-1/6 mx-auto"/>
			<InstrumentalnessBar class="w-1/6 mx-auto"/>
		</div>
		<div class="p-8 mx-auto flex justify-evenly space-x-5">
			<LivenessBar class="w-1/6 mx-auto"/>
			<SpeechinessBar class="w-1/6 mx-auto"/>
			<ValenceBar class="w-1/6 mx-auto"/>
		</div>
		<!--indeterminate -->
	</div>

	<div class="mx-auto my-20 w-1/2 bg-base-200 rounded-lg">
		<div class="p-8">
			<AudioFeatures class="w-1/2"/>
		</div>
	</div>
